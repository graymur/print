	...
	************************************************************************************************************/
	...
	switch(floating_window_skin){
		case 2:
			...
			var tabRightInActive = floating_window_image_prefix + "/skin2_tab_right_inactive.gif";
			var tabRightActive = floating_window_image_prefix + "/skin2_tab_right_active.gif";
			var tabImagePrefix = floating_window_image_prefix + "/skin2_tab_right_";
			var closeButtonMouseOverColor = '#006BF8';
			break;
		default:

			var tabRightInActive = BASE_URL + "/fwwt/images/tab_right_inactive.gif";
			var tabRightActive = floating_window_image_prefix + "/skin2_tab_right_active.gif";
			var tabImagePrefix = floating_window_image_prefix + "/skin2_tab_right_";
